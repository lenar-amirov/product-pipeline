...
RULES = {
    "analytics_brief": {
        ...
        "hint": "Когда передашь → <code>/analytics-brief-sent</code>",
        "remind_after_days": 1,
        "repeat_every_days": 0,
        "friday_digest": True,
    },
    "survey_brief": {
        ...
        "hint": "Когда передашь → <code>/survey-brief-sent</code>",
        "remind_after_days": 1,
        "repeat_every_days": 0,
        "friday_digest": True,
    },
    "audience_brief": {
        ...
        "hint": "Когда передашь → <code>/audience-brief-sent</code>",
        "remind_after_days": 1,
        "repeat_every_days": 0,
        "friday_digest": True,
    },
    "analytics_results": {
        ...
        "hint": "Когда получишь → открой Claude Code и напиши <code>/confirm-analytics-results</code>",
        "remind_after_days": 7,
        "repeat_every_days": 7,
        "friday_digest": True,
    },
    "survey_results": {
        ...
        "hint": "Когда получишь → <code>/confirm-survey-results</code>",
    ...
    "design_brief": {
        ...
        "hint": "Когда передашь → <code>/design-brief-sent</code>",
        "remind_after_days": 1,
        "repeat_every_days": 0,
    },
    "gate1_challenge": {
        ...
        "hint": "Когда сходишь → <code>/confirm-gate1-challenge</code>",
    ...
    "gate2_challenge": {
        ...
        "body": "Презентация готова, пора защищать",
        "hint": "Когда сходишь → <code>/confirm-gate2-challenge</code>",
        "remind_on": "next_monday",
    },
}
